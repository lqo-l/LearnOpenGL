...
int main(int argc, char **argv)
{
    ...
    // 着色器
    Shader shader(getAssetAbsPath(argv[0], "env_map.vert"), getAssetAbsPath(argv[0], "env_map.frag"));
...
#pragma endregion 
    ...
    std::string comicTexturePath = getAssetAbsPath(argv[0], "assets/04_advanced/textures/comic.png");
    ...
    unsigned int comicTexture = loadTexture(comicTexturePath.c_str());
    ...
    glBindTexture(GL_TEXTURE_2D, comicTexture);
