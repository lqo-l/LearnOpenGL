...
int main(int argc, char **argv)
{
    ...
    Shader normal_vis_shader(getAssetAbsPath(argv[0], "normal_vis.vert"), getAssetAbsPath(argv[0], "normal_vis.frag"), getAssetAbsPath(argv[0], "normal_vis.geom"));
    ...
    static float normalLength = 0.2f;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        normal_vis_shader.use();
        normal_vis_shader.setMat4("view", view);
        normal_vis_shader.setMat4("projection", projection);
        normal_vis_shader.setMat4("model", model);
        normal_vis_shader.setFloat("normalLength", normalLength);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        ...
        ImGui::NewFrame();
        {
            ...
            // ImGui::DragFloat("Explode Factor", &normalLength, 0.01f, -0.0f, 2.0f);
            ImGui::SliderFloat("Normal Length", &normalLength, -0.3f, 0.4f);
