...
int main(int argc, char **argv)
{
    ...
    // 着色器
    Shader shader(getAssetAbsPath(argv[0], "explode.vert"), getAssetAbsPath(argv[0], "explode.frag"), getAssetAbsPath(argv[0], "explode.geom"));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::DragFloat("Explode Factor", &explodeFactor, 0.01f, -1.0f, 5.0f);
