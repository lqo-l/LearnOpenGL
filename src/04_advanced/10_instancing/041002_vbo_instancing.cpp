...
int main(int argc, char **argv)
{
    ...
    // 着色器
    Shader common_shader(getAssetAbsPath(argv[0], "vbo_instancing.vert"), getAssetAbsPath(argv[0], "common.frag"));
    ...
    glBindVertexArray(quadVAO);  // 必须绑定VAO，否则顶点属性配置不会被记录
    ...
    glVertexAttribDivisor(2, 1); // 告诉OpenGL这是一个实例化的顶点属性，更新频率为1次/实例,而非每顶点更新
    glBindVertexArray(0);
